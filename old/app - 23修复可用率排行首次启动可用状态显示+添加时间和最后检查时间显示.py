            ...
            with self.lock:
                for d, t in self.trackers.items():
                    ...
                    if cache_hist:
                        ...
                        entry['history_7d']  = t.get('history_7d',[])
                        entry['history_30d'] = t.get('history_30d',[])
                    data[d] = entry
            ...
            with self.lock:
                for d, t in data.items():
                    ...
                    self.trackers[d] = {
                        ...
                        'history_24h': t.get('history_24h',[]),
                        'history_7d':  t.get('history_7d',[]),
                        'history_30d': t.get('history_30d',[]),
